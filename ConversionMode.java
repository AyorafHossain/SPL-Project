...
public class ConversionMode {
    ...
    private class ConvertButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                // Handle negative numbers for conversion
                ...
                // Re-apply negative sign if original input was negative
   ...
   // convert from decimal to other base
    private String convertFromDecimal(double decimal, String baseStr) {
        ...
        //  integer and fractional parts devide korce
        long integerPart = (long) decimal;
        double fractionalPart = decimal - integerPart;

        //  integer part ke convert korce
