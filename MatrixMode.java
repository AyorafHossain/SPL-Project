...
public class MatrixMode {
    ...
    public void createMatrixPanel(JPanel buttonPanel) {
        ...
        matrixButtonPanel.add(clearButton);
        ...
        comboBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                ...
                if (index == -1)
                {
                    ...
                    setForeground(new Color(235, 255, 255));
    ...
    private JSpinner createStyledSpinner(int value, int min, int max, int step) {
        ...
        for (Component component : components)
        {
            if (component instanceof JButton)
            {
                ...
                button.setBackground(new Color(70, 10, 180));
                button.setForeground(Color.WHITE);
    ...
    private void createMatrices() {
        ...
        clearButton.setEnabled(true); // Enable clear button when matrices are created
...
//performed matrix operation
    ...
    //perform addition and substractiom
    ...
    private void performMultiplication() {
        ...
        //check multiplication between two matrix are possible or not
        if (colsA != rowsB)
        {
